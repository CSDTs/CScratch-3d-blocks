...
module.exports = '<xml id="toolbox-categories" style="display: none">'+
  '<category name="Motion" colour="#4C97FF" secondaryColour="#3373CC">'+
    '<block type="motion_rotate" id="motion_rotate">'+
      '<value name="DEGREESX">'+
      ...
      '</value>'+
    '</block>'+
    '<block type="motion_setrotation" id="motion_setrotation">'+
      '<value name="DEGREESX">'+
        '<shadow type="math_number">'+
          '<field name="NUM">0</field>'+
        '</shadow>'+
      ...
      '</value>'+
    '</block>'+
    '<block type="motion_gotoxyz" id="motion_gotoxyz">'+
      '<value name="X">'+
  ...
  '<category name="Looks" colour="#9966FF" secondaryColour="#774DCB">'+
    ...
    '<block type="looks_switchbackdroptoandwait" id="looks_switchbackdroptoandwait">'+
      ...
      '</value>'+
    '</block>'+
    '<block type="looks_setscaleto" id="looks_setscaleto">'+
      '<value name="SCALEX">'+
        '<shadow type="math_number">'+
